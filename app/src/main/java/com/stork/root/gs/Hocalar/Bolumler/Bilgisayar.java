package com.stork.root.gs.Hocalar.Bolumler;
...
import com.stork.root.gs.Hocalar.BolumHocalarActivity;
import com.stork.root.gs.Hocalar.Hocalar;
import com.stork.root.gs.Hocalar.HocalarAdapter;
...
public class Bilgisayar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "https://gsuapp.000webhostapp.com/bolumhocalar/bilgisayar.php";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) Bilgisayar.this.getSystemService(Context.SEARCH_SERVICE);
        if (searchItem != null) {
            searchView = (SearchView) searchItem.getActionView();
        }
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(Bilgisayar.this.getComponentName()));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent intent = new Intent(Bilgisayar.this, BolumHocalarActivity.class);
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (Intent.ACTION_SEARCH.equals(intent.getAction())) {
            ...
            new Bilgisayar.AsyncFetch(query).execute();
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        ProgressDialog pdLoading = new ProgressDialog(Bilgisayar.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("https://gsuapp.000webhostapp.com/bolumhocalar/bilgisayarSearch.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("yok")) {
                Toast.makeText(Bilgisayar.this, "Yok", Toast.LENGTH_LONG).show();
            }else{
                ...
                try {
                    ...
                    mAdapter = new HocalarAdapter(Bilgisayar.this, data);
                    mRVhocalar.setAdapter(mAdapter);
                    mRVhocalar.setLayoutManager(new LinearLayoutManager(Bilgisayar.this));

                } catch (JSONException e) {
                    Toast.makeText(Bilgisayar.this, e.toString(), Toast.LENGTH_LONG).show();
                    Toast.makeText(Bilgisayar.this, result.toString(), Toast.LENGTH_LONG).show();
                }
